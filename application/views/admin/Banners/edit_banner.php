            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">               
                        ...
                        <form method="post" id="banners" name="banners" class="form-horizontal" action="<?php echo base_url() . "banners/edit_banner" ?>" enctype="multipart/form-data" >
                            <?php
//                            echo $_SESSION['firstname'];exit;
                            ...
                            <div class="form-group">
                                <input type="hidden" name="id" id="id" value="<?PHP echo $banner_data[0]->b_id ?>" />
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <img src="<?PHP echo base_url() ?>assets/images/icons/<?PHP echo $banner_data[0]->image ?>" width="50px"/>
                                </div>
                            </div>  
                            <div class="form-group">
                                <label class="col-sm-3 control-label capitalize">Title<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" id="title" name="title" class="form-control capitalize" value="<?PHP echo $banner_data[0]->title ?>" >
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-sm-3 control-label capitalize">Discription<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <textarea id="dicription" name="dicription" class="form-control capitalize"  ><?PHP echo $banner_data[0]->description ?></textarea>
                                </div>
                            </div>  
                            <div class="form-group">
                                <label class="col-sm-3 control-label capitalize">link<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" id="link" name="link" class="form-control capitalize" value="<?PHP echo $banner_data[0]->link ?>" />
                                </div>
                            </div>  
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">                                                                           
                                    <select name="rating" id="rating" class="form-control cat" style="width: 100%">
                                        <?PHP
                                        if (isset($banner_data[0]->rating)) {?>
                                       <option value="1" <?php if($banner_data[0]->rating == "1"){ echo "selected"; } ?> >1</option>
                                       <option value="2" <?php if($banner_data[0]->rating == "2"){ echo "selected"; } ?> >2</option>
                                       <option value="3" <?php if($banner_data[0]->rating == "3"){ echo "selected"; } ?> >3</option>
                                       <option value="4" <?php if($banner_data[0]->rating == "4"){ echo "selected"; } ?> >4</option>
                                       <option value="5" <?php if($banner_data[0]->rating == "5"){ echo "selected"; } ?> >5</option>
                                        <?PHP }
                                        ?>
