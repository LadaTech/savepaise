            ...
            <section class="section latest-deals-area">
                ...
                <div class="row row-masnory row-tb-20">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="deal-single panel">
                            <figure class="deal-thumbnail embed-responsive embed-responsive-16by9">
                                <!--<div class="label-discount left-90 top-2">-30%</div>-->
                                <h4 class="color-green mb-10 t-uppercase deal-off left-90 top-2">10% OFF</h4> 
                            ...
                            <div class="bg-white pt-20 pl-20 pr-15">
                                <div class="pr-md-10">
                                    ...
                                    <ul class="deal-meta list-inline mb-10 color-mid">
                                        <li><i class="ico fa fa-map-marker mr-10"></i>432 uses today</li>
                                        <li><i class="ico fa fa-shopping-basket mr-10"></i>Show all 52 offers</li>

                                    </ul>

                                </div>
                                <div class="deal-price pos-r mb-15">
                                    <h3 class="price ptb-5 text-right"><span class="price-sale"><i class="fa fa-inr"></i> 150.00</span><i class="fa fa-inr"></i> 100.00</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="deal-single panel">
                            ...
                            <div class="bg-white pt-20 pl-20 pr-15">
                                <div class="pr-md-10">
                                    ...
                                    <h3 class="deal-title mb-10">
                                        <a href="#">Hampton Bay LED Light Ceiling Exhaust </a>
                                    </h3>
                                    <ul class="deal-meta list-inline mb-10 color-mid">
                                        <li><i class="ico fa fa-map-marker mr-10"></i>654 uses today</li>
                                        <li><i class="ico fa fa-shopping-basket mr-10"></i>Show all 43 offers</li>
                                    </ul>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="deal-single panel">
                            <figure class="deal-thumbnail embed-responsive embed-responsive-16by9">
                                <div class="label-discount left-90 top-2">-15%</div>
                            ...
                            <div class="bg-white pt-20 pl-20 pr-15">
                                <div class="pr-md-10">
                                    ...
                                    <h3 class="deal-title mb-10">
                                        <a href="#">Timberland Men's Thorton Waterproof </a>
                                    </h3>
                                    <ul class="deal-meta list-inline mb-10 color-mid">
                                        <li><i class="ico fa fa-map-marker mr-10"></i>344 uses today</li>
                                        <li><i class="ico fa fa-shopping-basket mr-10"></i>Show all 52 offers</li>
                                    </ul>

                                </div>
                                <div class="deal-price pos-r mb-15">
                                    <h3 class="price ptb-5 text-right"><span class="price-sale"><i class="fa fa-inr"></i> 380.00</span><i class="fa fa-inr"></i> 340.00</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="deal-single panel">
                            <figure class="deal-thumbnail embed-responsive embed-responsive-16by9">
                                <div class="label-discount left-90 top-2">-60%</div>
                            ...
                            <div class="bg-white pt-20 pl-20 pr-15">
                                <div class="pr-md-10">
                                    ...
                                    <ul class="deal-meta list-inline mb-10 color-mid">
                                        <li><i class="ico fa fa-map-marker mr-10"></i>576 uses today</li>
                                        <li><i class="ico fa fa-shopping-basket mr-10"></i>Show all 29 offers</li>
                                    </ul>

                                </div>
                                <div class="deal-price pos-r mb-15">
                                    <h3 class="price ptb-5 text-right"><span class="price-sale"><i class="fa fa-inr"></i> 700.00</span><i class="fa fa-inr"></i> 576.00</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="deal-single panel">
                            ...
                            <div class="bg-white pt-20 pl-20 pr-15">
                                <div class="pr-md-10">
                                    ...
                                    <h3 class="deal-title mb-10">
                                        <a href="#">Buying a TV Is Easy When You Know </a>
                                    </h3>
                                    <ul class="deal-meta list-inline mb-10 color-mid">
                                        <li><i class="ico fa fa-map-marker mr-10"></i>34 uses today</li>
                                        <li><i class="ico fa fa-shopping-basket mr-10"></i>Show all 23 offers</li>
                                ...
                                <div class="deal-price pos-r mb-15">
                                    <h3 class="price ptb-5 text-right"><span class="price-sale"><i class="fa fa-inr"></i> 300.00</span><i class="fa fa-inr"></i> 250.00</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="coupon-item">
                        <div class="coupon-single panel t-center">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="text-center p-20">
                                        <img class="store-logo" src="assets/images/brands/brand_02.jpg" alt="">
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                    ...
                    <div class="coupon-item">
                        <div class="coupon-single panel t-center">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="text-center p-20">
                                        <img class="store-logo" src="assets/images/brands/brand_03.jpg" alt="">
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                    ...
                    <div class="coupon-item">
                        <div class="coupon-single panel t-center">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="text-center p-20">
                                        <img class="store-logo" src="assets/images/brands/brand_04.jpg" alt="">
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                    ...
                    <div class="coupon-item">
                        <div class="coupon-single panel t-center">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="text-center p-20">
                                        <img class="store-logo" src="assets/images/brands/brand_05.jpg" alt="">
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                                ...
                                <div class="col-xs-12">
                                    <div class="panel-body">
                                        ...
                                        <h4 class="color-green mb-10 t-uppercase">10% OFF</h4>
                                        <h5 class="deal-title mb-10">
                                            <a href="#">10% off <i class="fa fa-inr"></i> 399+ refurbished laptops</a>
                                        </h5>
                    ...
                    <div class="coupon-item">
                        <div class="coupon-single panel t-center">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="text-center p-20">
                                        <img class="store-logo" src="assets/images/brands/brand_06.jpg" alt="">
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                ...
                <div class="popular-stores-slider" data-loop="true" data-autoplay="true" data-smart-speed="1000" data-autoplay-timeout="10000" data-margin="20" data-items="2" data-xxs-items="2" data-xs-items="2" data-sm-items="3" data-md-items="5" data-lg-items="6">
                    ...
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Flipkart</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Snapdeal</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Shop & Shop</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Belk</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Gaming Store</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Albertsones</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            ...
                            <h6 class="store-name ptb-10">Walmart</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo view view-fifth">
                                    <img src="assets/images/brands/brand_09.jpg" alt="">
                                    <div class="mask">
                                        <h6>Gaint</h6> 												 
                                        <a href="#" class="info">73 Offers</a>
                                    </div>
                            ...
                            <h6 class="store-name ptb-10">Gaint</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo view view-fifth">
                                    <img src="assets/images/brands/brand_10.jpg" alt="">
                                    <div class="mask">
                                        <h6>Fredmayer</h6> 												 
                                        <a href="#" class="info">73 Offers</a>
                                    </div>
                            ...
                            <h6 class="store-name ptb-10">Fredmayer</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo view view-fifth">
                                    <img src="assets/images/brands/brand_11.jpg" alt="">
                                    <div class="mask">
                                        <h6>RiteAid</h6> 												 
                                        <a href="#" class="info">73 Offers</a>
                                    </div>
                            ...
                            <h6 class="store-name ptb-10">RiteAid</h6>
                        </a>
                    </div>
                    <div class="store-item t-center">
                        <a href="#" class="is-block">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo view view-fifth">
                                    <img src="assets/images/brands/brand_12.jpg" alt="">
                                    <div class="mask">
                                        <h6>Five Below</h6> 												 
                                        <a href="#" class="info">73 Offers</a>
                                    </div>
                            ...
                            <h6 class="store-name ptb-10">Five Below</h6>
                        </a>
                    </div>
                </div>
            </section>
