...
<section class="page">  
    <div class="container">
        ...
        <div class="row formContainer"> 
            <br />
            <div class="col-8">
                <form role="form" id="applicationform" class="form" name="applicationform" method="post" action="confirm.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <input type="hidden" id="applying_for" name="applying_for" value="merit" />
                                </div>
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="faddress" required="required" name="faddress" value="<?PHP echo $_SESSION['users']['faddress']; ?>" class="form-control" placeholder="Enter Location / Landmark" />
                                </div>

                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label class="control-label">Address 2</label>
                                    <input type="text" id="street" required="required" name="street" value="<?PHP echo $_SESSION['users']['street']; ?>" class="form-control" placeholder="Enter Street" />
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="cfaddress" required="required" name="cfaddress" value="<?PHP echo $_SESSION['users']['cfaddress']; ?>" class="form-control" placeholder="Enter Location / Landmark" />
                                </div>

                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label class="control-label">Street</label>
                                    <input type="text" id="cstreet" required="required" name="cstreet" value="<?PHP echo $_SESSION['users']['cstreet']; ?>" class="form-control" placeholder="Enter Street" />
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label class="control-label">City</label>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <?PHP
                                if ($_SESSION['users']['marksinsubject'] != '') {
                                    ?>

                                    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" id="markssubjectiddiv">
                                ...
                                <div class="clearfix"></div>
                                <?PHP
//                                foreach ($_FILES['markslist'] as $marks) {
                                    ?>
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
...
// }
                    ...
                    <input class="btn btn-success btn-lg pull-right" id="previewbutton" style="margin-right: 10px;" onclick="makeEditform('no');" type="button" value="View & Submit" />
