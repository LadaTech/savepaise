                        ...
                        <div class="page-content col-xs-12 col-md-9">
                            ...
                            <section class="section coupons-area coupons-area-grid">
                                ...
                                <header class="page-control panel ptb-15 prl-20 pos-r mb-30">
                                    ...
                                    <h3 class="section-title font-18">Coupons and Offers</h3>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_07.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_08.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_09.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_10.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_11.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="coupon-single panel t-center">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="text-center p-20">
                                                        <img class="store-logo" src="assets/images/brands/brand_12.jpg" alt="">
                                                    </div>
                                                    <!-- end media -->
                                                </div>
                                                <!-- end col -->
