...
if (isset($_SESSION['searchlist'])) {    
    ...
    $applicationNumber = $_SESSION['searchlist']['application_number'];
    $name = $_SESSION['searchlist']['studentname'];
    $surname = $_SESSION['searchlist']['studentsurname'];
    $applicationType = $_SESSION['searchlist']['type'];
    $emailid = $_SESSION['searchlist']['email'];
...
if ($_SESSION['searchlist']['status'] != '') {
    $applicationstatus = $_SESSION['searchlist']['status'];
    $whereCondition .= " and approval_status like '$applicationstatus'";
}
//echo "<pre>";
