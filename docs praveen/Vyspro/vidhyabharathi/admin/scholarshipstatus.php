...
//                        echo "</pre>";
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["month"]; ?> - <?PHP echo $usersdata["year"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Marks obtained</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["marksobtained"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Percentage of marks</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["percentagemarks"]; ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["annual_income"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Annual Income certificate</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><a href="/uploads/<?PHP echo $usersdata[Annual_Income_certificate]; ?>" target="_blank" ><img width="80px" src="/uploads/<?PHP echo $usersdata[Annual_Income_certificate]; ?>" /></a></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Any other scholarships received</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["other_scholarships"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Did you receive scholarship from Vyspro-India</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["vyspro_scholarship"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Year of latest scholarship received</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["vyspro_scholarship_year"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Are your Parent / Guardian is a member of any Vysya Association</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["parents_in_vyspro"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Organisation Name</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["organisationname"]; ?></td>
                            </tr>                            
                            <tr>
                                <td colspan="3" style="width:700px; border-bottom:2px solid black;">&nbsp;</td>                                  
                            </tr>         
                            ...
                            <tr>
                                ...
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["bankstudentname"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Bank Name</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["bank_name"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Bank A/C number</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["account_number"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Bank IFSC code</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["ifsc_code"]; ?></td>
                            </tr>
                            <tr>
                                <td class="labeltext">Bank Branch</td>
                                <td class="coluntd">:</td>
                                <td class="labelvalue"><?PHP echo $usersdata["bank_branch"]; ?></td>
                            </tr>
