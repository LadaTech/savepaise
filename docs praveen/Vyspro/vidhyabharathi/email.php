                        ...
                        <table style="width: 100%; height:100px;">
                            ...
                            <tr>
                                <td colspan="3">
                                    <section class="page">  
                                        <div class="container">
                                            <h3 style="color: #D70000;">%%%thanksTitle%%%</h3>
                                            <div class="row formContainer"> 
                                                <h3>Thanks for submitting your application. <br />
                                                    Your application number is %%%referenceID%%%, please keep this for future reference. <br />
                                                </h3>
                                                <ul>
                                                ...
                                                <h3>Please send below documents to Project Chairman Address below:</h3><br />
                                                <p>CA Ramesh Babu Kollipara,<br />
