        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">               
                        <!-- PAGE CONTENT BEGINS -->
                      <form method="post" id="catgroups"  class="form-horizontal" action="<?php echo base_url() . "category/edit_catgroup" ?>" enctype="multipart/form-data" >
                            ...
                            <div class="col-sm-6">
                                <select id="cat_names" name="catg_names" id="catg_names"  class="form-control" style="width: 100%" data-placeholder="Basic Select2 Box">
                                    ...
                                    foreach ($categories as $ind) {
                                        if ($catGroup[0]->cate_id == $ind['cat_id']) {
                                            $selected = "selected";
                                        } else {
                                            $selected = "";
                                        }
                                        ...
                                        <option value="<?php echo $ind['cat_id']; ?>" <?PHP echo $selected; ?> ><?php echo $ind['cat_name']; ?></option>
                                    <?php } ?>
                                </select>
                                <input type="hidden" id="editgroupId" name="editgroupId" value="<?PHP echo $_REQUEST['catid'] ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label capitalize">Category Group <span class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" name="c_group" id="c_group" class="form-control capitalize" value="<?PHP echo $catGroup[0]->group_name; ?>" placeholder="Enter Category" required/>
                            </div>
                        </div>
                        <div class="form-group">
