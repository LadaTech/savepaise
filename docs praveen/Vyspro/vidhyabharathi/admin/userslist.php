...
if ($_REQUEST["status"] != '') {
    $_SESSION['searchlist']['status'] = urldecode($_REQUEST["status"]);
    $applicationType = urldecode($_REQUEST["status"]);
    $whereCondition .= " and approval_status like '$applicationType'";
}
$select = "select * from vb_users where 1=1 and applying_for in ('merit','scholarship')  $whereCondition order by id desc";
        ...
        <div class="row">     
            <div class="col-md-12 formContainer clearfix">
                <div class="payuform">
                    ...
                    <!--                    <form class="form-inline" method="post" action="/admin/userslist.php">
                    ...
                    ?>" />
                                            ...
                                            <a href="/admin/exportlist.php" class="btn btn-primary pull-right" style="margin:10px 5px;">Excel export</a>
                    ...
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="th-sm">income Certificates</th>
                                <th class="th-sm">Marks Certificates</th>
...
//                                    echo "id: " . $row["id"] . " - Name: " . $row["firstname"] . " " . $row["lastname"] . "<br>";
                                    ...
                                    ?>status.php?id=<?PHP echo $row["application_number"]; ?>" target="_blank"><?PHP echo $row["application_number"]; ?></a><br /><?PHP echo ucwords($row["applying_for"]); ?></td>
                                        ...
                                        <td style="word-wrap: break-word; width:100px;"><?PHP echo $row["Annual_Income_certificate"]; ?></th>
                                        <td style="word-wrap: break-word;  width:100px;"><?PHP echo $row["marks_proof_certificate"]; ?></th>
