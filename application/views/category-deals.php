                                ...
                                <div class="row row-tb-10">
                                        ...
                                        <div class="widget latest-deals-widget panel prl-20">
                                            <div class="widget-body ptb-20">
                                               <div class="coupon-logo">
													<img src="assets/images/deals/thumb_01.jpg" />													 
									...
									<div class="col-xs-12">
                                        ...
                                        <div class="widget subscribe-widget panel pt-20 prl-20">
                                            <h3 class="widget-title h-title">Stores</h3>
                                            <div class="widget-content ptb-10" id="style-3">
                                                ...
                                                <form method="post" action="#">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="radio" class="custom-radio"> eBay                                                        
                                                    </div>
													<div class="input-group">
                                                        <input type="radio" class="custom-radio"> Jbong                                                        
                                                    </div>
													<div class="input-group">
                                                        <input type="radio" class="custom-radio"> First Cry                                                        
                                                    </div>
													<div class="input-group">
                                                        <input type="radio" class="custom-radio"> eBay                                                        
                                                    </div>
                                            ...
                                            <div class="widget-body ptb-30">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img class="media-object" src="assets/images/brands/brand_01.jpg" alt="Thumb" width="80">
                                                        </a>
                                                    </div>
                        ...
                        <div class="page-content col-xs-12 col-md-9">
                            <section class="section coupons-area coupons-area-list">
                                ...
                                <header class="page-control panel ptb-15 prl-20 pos-r mb-30">
                                    <!-- List Control View -->
                                     <h3 class="section-title font-18">Fashion Deals and Coupons</h3>
									...
									<form method="post" action="#">
                                                    ...
                                                    <div class="deals-filter-radio">
                                                         <input type="radio" class="custom-radio">   Deals                                                      
                                                    </div>
													<div class="deals-filter-radio">
                                                        <input type="radio" class="custom-radio">  Coupons                                                     
                                                    </div>
									</form>
									</div>
                                    <!--<div class="right-10 pos-tb-center">
                                ...
                                <div class="row row-masnory row-tb-20">
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_11.jpg" alt=""></div>
                                                        <div class="showcode">
									...
									<div class="text-center">									 
									<div class="add-728x90"><p>add size will be 728x90 here</p></div>									 
									</div>
                                    <div class="col-xs-12">
                                        <div class="coupon-single panel t-center t-sm-left">
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_10.jpg" alt=""></div>
                                                        <div class="showcode">
                                                            <button class="show-code btn btn-sm btn-block" data-toggle="modal" data-target="#coupon_06">Show Code</button>
                                                            <div class="coupon-hide">X455-17GT-OL58</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_09.jpg" alt=""></div>
                                                        <div class="showcode">
                                                            <button class="show-code btn btn-sm btn-block" data-toggle="modal" data-target="#coupon_07">Show Code</button>
                                                            <div class="coupon-hide">X455-17GT-OL58</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_08.jpg" alt=""></div>
                                                        <div class="showcode">
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_07.jpg" alt=""></div>
                                                        <div class="showcode">
                                                            <button class="show-code btn btn-sm btn-block" data-toggle="modal" data-target="#coupon_09">Show Code</button>
                                                            <div class="coupon-hide">X455-17GT-OL58</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_06.jpg" alt=""></div>
                                                        <div class="showcode">
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_05.jpg" alt=""></div>
                                                        <div class="showcode">
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>
														<div class="dealBox-logo"><img src="assets/images/brands/brand_04.jpg" alt=""></div>
                                                        <div class="showcode">
                                                            <button class="show-code btn btn-sm btn-block" data-toggle="modal" data-target="#coupon_12">Show Code</button>
                                                            <div class="coupon-hide">X455-17GT-OL58</div>
                                                        </div>
                                                    </div>
                                                </div>
