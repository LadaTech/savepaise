                                    ...
                                    <section class="page">  
                                        <div>
                                            ...
                                            <div class="row formContainer"> 
                                                <p>
                                                    <span style="font-weight:bold">Dear %%%studentname%%%,</span><br />
                                                    <br />
                                                    With reference to your Application No.<span style="font-weight:bold"> %%%number%%% </span> for Merit Award, we are Happy to inform you that you are selected for <span style="font-weight:bold"> %%%medaltype%%% </span> Medal for securing highest marks in <span style="font-weight:bold"> %%%study%%% </span> Category for the Academic Year 2018-19.
                                                    <br />
                                                    <br />
                                                    You are requested to make yourself available for the event, along with your Parents, on Sunday, 22nd December 2019 at our Vyspro – India Office to receive the Medal Award.
                                                    <br />                                       
                                                    <br />
                                                    ...
                                                    <br />
                                                    <br />
                                                    We will update you further program details in due course. <br />
                                                    <br /><br />
...
<br />
                                                ...
                                                <p>
                                                    <span style="font-weight:bold;">Note:</span><br /><br /> 

                                                    We request you to send your AV (Audio-Video) covering the below given 4 points for duration around One minute. 
                                                    <br />
                                                <ul>
                                                    <li>Introduction of yourself</li>
                                                    <li>How did you achieve this goal</li>
                                                    <li>What is ambition</li>
                                                    <li>How you are going to help Vyspro - India</li>

                                                </ul>
                                                </p>
                                                <p>
                                                    <span style="font-weight:bold;">Your AV shall reach us by Friday (i.e. 20 Dec 2019) 6.00 p.m to the below given WhatsApp No. 9441820017</span> 
                                                </p>
                                            </div>
                                        </div>
                                    </section>
