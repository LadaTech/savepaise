    ...
    <div>
        <table class="page" style="border:2px solid black; padding:20px; width:680px;">
            ...
            <tr>
                ...
                <td style="color:red; text-align:right; padding-right:20px;">' . $_REQUEST[id] . '</td>
            </tr>
            <tr>
                <td colspan="3">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["parent_name"] . '</td>
                        </tr>
                        <tr>
                            <td class="labeltext">Occupation</td>
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["occupation"] . '</td>
                        </tr>
                        <tr>
                            <td class="labeltext">Father/Guardian Phone Number</td>
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["parent_phone"] . '</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["mother_phone"] . '</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="coluntd">:</td>
                            <td class="labelvalue" colspan="3">' . $usersdata["address"] . ', ' . $usersdata["street"] . ',<br /> ' . $usersdata["city"] . ' ' . $usersdata["pincode"] . ' ' . $usersdata["state"] . '</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["latest_class_completed"] . '</td>
                        </tr>
                        <tr>
                            <td class="labeltext">Month - Year (Year of passing)</td>
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["month"] . ' - ' . $usersdata["year"] . '</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["name_of_school"] . '</td>
                        </tr>
                        <tr>
                            <td class="labeltext">School / Collage / Institution Address</td>
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["school_address"] . '</td>
                        </tr>
                        <tr>
                            <td class="labeltext">Presently studying</td>
                            <td class="coluntd">:</td>
                            <td class="labelvalue">' . $usersdata["current_studying"] . '</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="width:700px; border-bottom:2px solid black;">&nbsp;</td>                                    
                        </tr>
        ...
        <table class="page break-before" style="border:2px solid black; padding:20px; width:680px;">                            
            ...
            <tr>
                ...
                <td class="coluntd">:</td>
                <td class="labelvalue">' . $usersdata["bank_name"] . '</td>
            </tr>
            <tr>
                <td class="labeltext">Bank A/C number</td>
                <td class="coluntd">:</td>
                <td class="labelvalue">' . $usersdata["account_number"] . '</td>
            </tr>
            <tr>
                <td class="labeltext">Bank IFSC code</td>
                <td class="coluntd">:</td>
                <td class="labelvalue">' . $usersdata["ifsc_code"] . '</td>
            </tr>
            <tr>
                <td class="labeltext">Bank Branch</td>
                <td class="coluntd">:</td>
                <td class="labelvalue">' . $usersdata["bank_branch"] . '</td>
            </tr>
            <tr>
                <td colspan="3" style="width:700px; border-bottom:2px solid black;">&nbsp;</td>                                  
            </tr>
